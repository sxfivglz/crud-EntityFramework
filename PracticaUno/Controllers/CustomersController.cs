...
namespace PracticaUno.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("customer_id,name,address,website,credit_limit")] Customers customers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("customer_id,name,address,website,credit_limit")] Customers customers)
        {
